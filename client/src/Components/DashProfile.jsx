...
//   //Giving reference to the profile image to select the image form the device
...
//   const uploadImage = async () => {
//     const firebaseApp = getFirebaseApp(); // Get the Firebase app instance
...
//     // Implement this function to obtain your Firebase app instance
//     // Initialize Firebase and return the app instance here
//     // For example:
...
//           <img
//             src={imageFileUrl || currentUser.avatar}
//             // alt="user" //This is alternative to the image
//             className="rounded-full w-full h-full object-cover border-8 border-indigo-50"
//           />
//         </div>
...
//         />
//         <TextInput type="password" id="password" placeholder="Password" />
//         <button type="submit" className="outline rounded-md bg-green-700">
//           Update
//         </button>
//       </form>
//       <div className=" flex justify-between mt-5">
